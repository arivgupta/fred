// Hand-rolled SVG icon set (lucide/feather-style, 24px grid, stroke-based).
// Zero-dependency so the bundle stays tiny and offline-friendly.
...
// Google's multi-color mark — the one icon that isn't stroke-based.
